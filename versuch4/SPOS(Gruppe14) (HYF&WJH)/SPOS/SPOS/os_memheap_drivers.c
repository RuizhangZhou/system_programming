...
static char PROGMEM const intStr[] = "internal";
static char PROGMEM const extStr[] = "external";
...
Heap extHeap__={
	.driver=extSRAM,
	.mapStart=SRAM_EXTERNAL_START,
	.mapSize=(SRAM_EXTERNAL_SIZE / 3),
	.useStart=SRAM_EXTERNAL_START + (SRAM_EXTERNAL_SIZE / 3),
	.useSize=(SRAM_EXTERNAL_SIZE / 3) * 2,
	.currentAllocStrategy=OS_MEM_FIRST,
}
