 ...
 *
 *  Ermittelt indem wir den Boden des Stacks eines hypothetischen neunten Prozesses nehmen,
 *  welcher gleichzeitig das obere Ende des Stacks des achten (h�chsten) Prozesses ist.
 */
