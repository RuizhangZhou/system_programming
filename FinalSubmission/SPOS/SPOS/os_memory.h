...
/*!
 *  Versucht, size viele zusammenh�ngende bytes zu allokieren.
 *  Falls kein passender Platz gefunden, wird 0 zur�ckgegeben.
 */
 ...
 *  Versuchte Freigabe fremden Speichers f�hrt zu Fehlermeldung.
...
/*! 
 *  liefert Gr��e des Speicherbereichs in Byte zur�ck.
...
//! gibt alles frei, was Prozess `pid`geh�rt.
void os_freeProcessMemory (Heap *heap, ProcessID pid);

//! versucht Speicherbereich zu vergr��ern/verkleinern oder malloc neu und verschiebt Chunk
...
//! �ffnet shm, falls grad keiner liest Eigentlich private.
MemAddr os_sh_readOpen(Heap const* heap, MemAddr const *ptr);

//! �ffnet shm, falls grad keiner schreibt. Eigentlich private.
